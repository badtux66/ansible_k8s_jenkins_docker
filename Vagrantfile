...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ansible" do |ansible|
    ...
    ansible.vm.network "public_network", bridge: $network_interface, ip: "192.168.174.2", netmask: "255.255.255.0", use_dhcp_assigned_default_route: true
  ...
  config.vm.define "jenkins" do |jenkins|
    ...
    jenkins.vm.network "public_network", bridge: $network_interface, ip: "192.168.174.3", netmask: "255.255.255.0", use_dhcp_assigned_default_route: true
  ...
  config.vm.define "k8s" do |k8s|
    ...
    k8s.vm.hostname = "k8s"
    k8s.vm.network "public_network", bridge: $network_interface, ip: "192.168.174.5", netmask: "255.255.255.0", use_dhcp_assigned_default_route: true
